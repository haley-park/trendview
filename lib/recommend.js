...
export const ACCOUNT_POOL = {
  ...
  x: [
    ...
    { name: "xai", tags: ["ai"] },
    // 지역별 AI 빌더
    { name: "hunkims", tags: ["ai", "people"] },
    { name: "upstageai", tags: ["ai"] },
    { name: "deepseek_ai", tags: ["ai"] },
    { name: "Alibaba_Qwen", tags: ["ai"] },
    { name: "Kimi_Moonshot", tags: ["ai"] },
    { name: "Kling_ai", tags: ["ai", "video"] },
    { name: "SakanaAILabs", tags: ["ai"] },
    { name: "hardmaru", tags: ["ai", "people"] },
    { name: "karaage0703", tags: ["ai", "people"] },
    { name: "DotCSV", tags: ["ai", "people"] },
    { name: "javilopen", tags: ["ai", "people"] },
  ],
  threads: [
