...
// X·스레드 기본 계정: AI 빌더·유명 AI 계정 (전 언어 공통)
const X_AI_BUILDERS = [
  "OpenAI", "sama", "karpathy", "AnthropicAI", "GoogleDeepMind",
  "elonmusk", "ylecun", "gdb", "AndrewYNg", "MistralAI",
];
const THREADS_AI_BUILDERS = [
  "openai", "zuck", "mosseri", "meta.ai", "google", "nvidia", "github", "microsoft",
];
