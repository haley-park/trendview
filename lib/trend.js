...
export const CATEGORY_QUERIES = {
  food: { ko: "먹방", en: "mukbang food", zh: "吃播 美食", ja: "モッパン 大食い" },
  beauty: { ko: "뷰티 메이크업 패션", en: "beauty makeup fashion", zh: "美妆 穿搭", ja: "メイク 美容" },
  vlog: { ko: "브이로그", en: "vlog", zh: "vlog 日常", ja: "vlog 日常" },
  fun: { ko: "예능 웃긴 영상", en: "comedy funny videos", zh: "搞笑 综艺", ja: "お笑い 面白" },
  movie: { ko: "영화 드라마 리뷰", en: "movie drama review", zh: "电影 电视剧 解说", ja: "映画 ドラマ 考察" },
  tech: { ko: "테크 리뷰", en: "tech review", zh: "科技 测评", ja: "ガジェット レビュー" },
  edu: { ko: "지식 교양", en: "educational explained", zh: "知识 科普", ja: "教養 解説" },
  travel: { ko: "여행", en: "travel", zh: "旅行", ja: "旅行" },
  animal: { ko: "강아지 고양이", en: "dog cat pets", zh: "狗 猫 宠物", ja: "犬 猫" },
};
...
export async function getXPosts(accounts, force) {
  const fetchFn = async () => {
    // syndication은 동시 요청이 많으면 빈 응답 → 동시성 3
...
export { httpGet, httpJSON, httpText, UA };
